        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <p>
                        <input type="text" id="maxAgeInDaysOfFeatureBranches" value="${maxAgeInDaysOfFeatureBranches}"
                               accept="number" maxlength="3" size="3"/>
                        <label for="maxAgeInDaysOfFeatureBranches">Max age in days of feature branches</label>
                    </p>

                    <p>
                        <input type="text" id="maxNumberOfFeatureBranches" value="${maxNumberOfFeatureBranches}"
                               accept="number" maxlength="3" size="3"/>
                        <label for="maxNumberOfFeatureBranches">Max number of feature branches with recent activity to
                            show</label>
                    </p>
                </td>
            </tr>
                ...
                <td>
                    <div>
                        <input type="button" id="piazzaSaveButton"
                               onclick="$('piazzaSaveButton').disabled='true';  BS.Util.show($('piazzaSaveProgress')); return Piazza.saveProjectSettings();"
                               value="Save"/>
